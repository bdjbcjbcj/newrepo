      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,340px)_1fr]">
        ...
        >
          ...
          <div className="mb-5 flex items-center gap-4">
            <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-full bg-linear-to-br from-indigo-500 to-indigo-700 text-lg font-bold text-white flex items-center justify-center">
              {PROFILE.name
                .split(" ")
                .map((n) => n[0])
                .join("")}
