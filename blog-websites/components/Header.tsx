...
const Header = () => {
  ...
  return (
    <header className="relative overflow-hidden bg-linear-to-br from-slate-50 via-white to-indigo-50">
      ...
      />
        ...
        <div className="text-center py-20 lg:py-28">
          ...
          <h1 className="text-5xl md:text-7xl font-black leading-tight text-gray-900">
            ...
            Discover Amazing
            <span className="block bg-linear-to-r from-indigo-600 via-purple-600 to-pink-500 bg-clip-text text-transparent">
              Stories & Ideas
            </span>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center rounded-2xl bg-white p-2 shadow-2xl border border-gray-200">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full sm:w-auto mt-2 sm:mt-0 rounded-xl bg-linear-to-r from-indigo-600 to-purple-600 px-8 py-4 text-white font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl disabled:opacity-60"
              >
