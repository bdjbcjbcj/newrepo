  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8 px-4">
      <div className="mx-auto max-w-2xl rounded-2xl bg-white shadow-lg border border-gray-200">
        ...
        {/* Header */}
        <div className="rounded-t-2xl bg-linear-to-r from-blue-600 to-indigo-600 px-6 py-5">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-linear-to-r from-blue-600 to-indigo-600 py-3 font-semibold text-white shadow-md transition hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-70"
          >
            {loading ? (
              <>
