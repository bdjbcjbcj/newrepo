...
var processClassGroups = (classGroups, theme2) => {
  ...
  for (const classGroupId in classGroups) {
    ...
    processClassesRecursively2(group, classMap, classGroupId, theme2);
  }
  return classMap;
};
...
var processObjectDefinition = (classDefinition, classPartObject, classGroupId, theme2) => {
  ...
  for (let i = 0; i < len; i++) {
    ...
    processClassesRecursively2(value, getPart2(classPartObject, key), classGroupId, theme2);
  }
};
...
var createLruCache2 = (maxCacheSize) => {
  ...
  let cacheSize = 0;
  let cache6 = /* @__PURE__ */ Object.create(null);
  ...
  const update = (key, value) => {
    ...
    if (cacheSize > maxCacheSize) {
      cacheSize = 0;
      previousCache = cache6;
      cache6 = /* @__PURE__ */ Object.create(null);
    }
  };
  return {
    get(key) {
      let value = cache6[key];
      if (value !== void 0) {
        return value;
      }
...
var createSortModifiers = (config) => {
  ...
  config.orderSensitiveModifiers.forEach((mod, index3) => {
...
var mergeClassList2 = (classList, configUtils) => {
  ...
  for (let index3 = classNames.length - 1; index3 >= 0; index3 -= 1) {
    ...
    const variantModifier = modifiers.length === 0 ? "" : modifiers.length === 1 ? modifiers[0] : sortModifiers2(modifiers).join(":");
...
var isArbitraryShadow2 = (value) => getIsArbitraryValue2(value, isLabelShadow, isShadow2);
...
var getDefaultConfig2 = () => {
  ...
  const scalePositionWithArbitrary = () => [...scalePosition(), isArbitraryVariable, isArbitraryValue2];
  ...
  const scaleBgPosition = () => [...scalePosition(), isArbitraryVariablePosition, isArbitraryPosition2, {
    position: [isArbitraryVariable, isArbitraryValue2]
  }];
  const scaleBgRepeat = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }];
  const scaleBgSize = () => ["auto", "cover", "contain", isArbitraryVariableSize, isArbitrarySize2, {
    size: [isArbitraryVariable, isArbitraryValue2]
  }];
  const scaleGradientStopPosition = () => [isPercent2, isArbitraryVariableLength, isArbitraryLength2];
  const scaleRadius = () => [
  ...
  const scaleMaskImagePosition = () => [isNumber2, isPercent2, isArbitraryVariablePosition, isArbitraryPosition2];
  const scaleBlur = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
  ...
  return {
    ...
    classGroups: {
       ...
       */
      "inset-shadow": [{
        "inset-shadow": ["none", themeInsetShadow, isArbitraryVariableShadow, isArbitraryShadow2]
      }],
      /**
       ...
       */
      "text-shadow": [{
        "text-shadow": ["none", themeTextShadow, isArbitraryVariableShadow, isArbitraryShadow2]
      }],
      /**
       * Text Shadow Color
      ...
      "mask-image-radial": [{
        "mask-radial": [isArbitraryVariable, isArbitraryValue2]
      }],
       ...
       */
      "mask-image": [{
        mask: ["none", isArbitraryVariable, isArbitraryValue2]
      }],
      // ---------------
      // --- Filters ---
      // ---------------
    ...
    return (0, import_jsx_runtime22.jsx)(
      "div",
      {
        className: twMerge3(
          ...
          hideScrollbars && "[&::-webkit-scrollbar]:!hidden [&::-webkit-scrollbar]:!h-0 [&::-webkit-scrollbar]:!w-0 [&::-webkit-scrollbar]:!bg-transparent [&::-webkit-scrollbar]:![-webkit-appearance:none]"
        ),
        style,
        ref: this.getRef,
...
var ModalHeader = (0, import_react103.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime92.jsxs)("div", { ref, className: twMerge3(theme2.base, popup && theme2.popup, className), ...restProps, children: [
    ...
    dismissible && (0, import_jsx_runtime92.jsx)("button", { "aria-label": "Close", className: theme2.close.base, type: "button", onClick: onClose, children: (0, import_jsx_runtime92.jsx)(OutlineXIcon, { "aria-hidden": true, className: theme2.close.icon }) })
  ] });
});
